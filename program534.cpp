...
#include<stdio.h>        // Provides standard input and output functions like printf() and fgets()
#include<stdlib.h>       // Provides memory allocation and utility functions like malloc() and free()
#include<fcntl.h>        // Provides file control options and flags (used for file access modes)
#include<unistd.h>       // Provides POSIX system calls like read(), write(), and close()
#include<stdbool.h>      // Provides boolean data type (true and false)
#include<string.h>       // Provides string handling functions like strcpy() and strlen()
